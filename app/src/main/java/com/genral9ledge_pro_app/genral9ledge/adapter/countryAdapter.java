...
public class countryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final ArrayList<Country> mainList;
    private callBack callback;

    public countryAdapter(Activity activity, ArrayList<Country> mainList, callBack callback) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == ITEM_VIEW) {
            ...
            return new countryAdapter.MainViewHolder(view);
        } else if (viewType == AD_VIEW) {
            View view = layoutInflater.inflate(R.layout.layout_ad, parent, false);
            return new countryAdapter.AdViewHolder(view);
        } else {
            return null;
        }
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder.getItemViewType() == ITEM_VIEW) {
            ...
            ((countryAdapter.MainViewHolder) holder).bindData(mainList.get(pos),positions);
        } else if (holder.getItemViewType() == AD_VIEW) {
            ((countryAdapter.AdViewHolder) holder).bindAdData();
        }
    ...
    public class MainViewHolder extends RecyclerView.ViewHolder {
        ...
        private void bindData(Country main, int positions) {
            binding.rajdhaniName.setText(main.getRajdhani());
            binding.rajyaName.setText(main.getRajya());
