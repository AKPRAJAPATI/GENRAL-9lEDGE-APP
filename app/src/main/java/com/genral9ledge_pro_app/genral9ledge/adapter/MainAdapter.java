...
public class MainAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final ArrayList<personModel> mainList;
    private callBack callback;

    public MainAdapter(Activity activity, ArrayList<personModel> mainList, callBack callback) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder.getItemViewType() == ITEM_VIEW) {
            ...
            ((MainViewHolder) holder).bindData(mainList.get(pos),positions);
    ...
    public class MainViewHolder extends RecyclerView.ViewHolder {
        ...
        private void bindData(personModel main, int positions) {
