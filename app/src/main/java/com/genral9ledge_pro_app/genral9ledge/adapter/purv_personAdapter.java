...
import com.genral9ledge_pro_app.genral9ledge.databinding.PurvPersonItemBinding;
...
public class purv_personAdapter   extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private static final int ITEM_VIEW = 0;
    private static final int AD_VIEW = 1;
    private static final int ITEM_FEED_COUNT = 5;
    private final Activity activity;
    private final ArrayList<purvPradhanMantri> mainList;
    private callBack callback;

    public purv_personAdapter(Activity activity, ArrayList<purvPradhanMantri> mainList, callBack callback) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == ITEM_VIEW) {
            View view = layoutInflater.inflate(R.layout.purv_person_item, parent, false);
            return new purv_personAdapter.MainViewHolder(view);
        } else if (viewType == AD_VIEW) {
            View view = layoutInflater.inflate(R.layout.layout_ad, parent, false);
            return new purv_personAdapter.AdViewHolder(view);
        } else {
            return null;
        }
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder.getItemViewType() == ITEM_VIEW) {
            ...
            ((purv_personAdapter.MainViewHolder) holder).bindData(mainList.get(pos),positions);
        } else if (holder.getItemViewType() == AD_VIEW) {
            ((purv_personAdapter.AdViewHolder) holder).bindAdData();
        }
        ;
    ...
    public class MainViewHolder extends RecyclerView.ViewHolder {
        ...
        PurvPersonItemBinding binding;

        public MainViewHolder(@NonNull View itemView) {
            super(itemView);
            binding = PurvPersonItemBinding.bind(itemView);
        }
        private void bindData(purvPradhanMantri main, int positions) {

            binding.myProfile.setImageResource(main.getPhoto());
